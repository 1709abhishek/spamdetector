...
common_spammy_words = ['udacity','course','save','coupon','free','discount']

reddit = praw.Reddit(client_id = 'Eb9FIjUfJ8zg8A',
...
if __name__ == "__main__":
    while True:
        current_search_query = random.choice(["udacity"])
        spam_content = []
        trashy_users = {}
        ...
        for spam in spam_content:
            ...
            if time.time()-created_time <= 86400:
                ...
                message = """achint and abhishek minor.....
I am a bot that sniffs out spammers, and this smells like spam.

Don't let spam take over Reddit! Throw it out!""".format(round(trashy_users[spam_user][0]*100,2), trashy_users[spam_user][1], spam_user)
